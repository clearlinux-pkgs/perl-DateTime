...
%prep
%setup -q -n DateTime-1.54
cd %{_builddir}/DateTime-1.54
...
cp %{_builddir}/DateTime-1.54/LICENSE %{buildroot}/usr/share/package-licenses/perl-DateTime/894eb8fcf1e8a04dbe84351c9f0c998531d50a2b
if test -f Makefile.PL; then
