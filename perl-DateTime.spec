...
%prep
%setup -q -n DateTime-1.58
cd %{_builddir}/DateTime-1.58
...
cp %{_builddir}/DateTime-1.58/LICENSE %{buildroot}/usr/share/package-licenses/perl-DateTime/46f08563dc1bb460f0df7ba280b04c15946dd909
if test -f Makefile.PL; then
